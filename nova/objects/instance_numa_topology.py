...
class VirtualPMEM(base.NovaObject,
    ...
    fields = {
        'size_mb': obj_fields.IntegerField(),
        'backend_dev': obj_fields.StringField(nullable=True, default=None),
        'backend_ns_uuid': obj_fields.UUIDField(nullable=True, default=None),
    }
