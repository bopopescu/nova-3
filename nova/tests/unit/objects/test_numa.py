...
class _TestNUMA(object):
    ...
    def test_obj_make_compatible_pre_1_4(self):
        fake_obj_pmem_namespaces = [
            objects.PMEMNamespace(uuid=uuids.ns1, name='ns_1', region=1,
                dev='dev_1', size_mb=4096, alignment=2097152, assigned=False),
            objects.PMEMNamespace(uuid=uuids.ns2, name='ns_2', region=1,
                dev='dev_2', size_mb=4096, alignment=2097152, assigned=False)]
